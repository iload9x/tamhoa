...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/{{ App\Helpers\AssetHelper::path() }}assets/lib/material-design-icons/css/material-design-iconic-font.min.css" />
  <!--[if lt IE 9]>
    <script src="https://oss.maxcdn.com/html5shiv/3.7.2/html5shiv.min.js"></script>
    <script src="https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
    <![endif]-->
  <link rel="stylesheet" type="text/css" href="/{{ App\Helpers\AssetHelper::path() }}assets/lib/summernote/summernote.css"/>
  <link rel="stylesheet" href="/{{ App\Helpers\AssetHelper::path() }}assets/css/style.css" type="text/css" />
  <link rel="stylesheet" href="/{{ App\Helpers\AssetHelper::path() }}css/custom.css" type="text/css" />
</head>
<body>
  <div class="container">
    <div class="bannder-game">
      <img src="{{ App\Helpers\ConfigHelper::get_keyword('banner')->value }}" alt="">
    </div>
  ...
  <script src="/{{ App\Helpers\AssetHelper::path() }}assets/lib/summernote/summernote.min.js" type="text/javascript"></script>
  <script src="/{{ App\Helpers\AssetHelper::path() }}assets/lib/summernote/summernote-ext-beagle.js" type="text/javascript"></script>
  <script src="/{{ App\Helpers\AssetHelper::path() }}assets/lib/parsley/parsley.min.js" type="text/javascript"></script>
